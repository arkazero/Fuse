...
public class JSONPathCustomerBean{
	...
	public void process(@JsonPath("$.customer.id") Integer id,
			@JsonPath("$.customer.firstName") String firstName,
			@JsonPath("$.customer.lastName") String lastName,
			@JsonPath("$.customer.email") String email, Exchange exchange) throws Exception {
