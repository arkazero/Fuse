...
//			switch (value) {
//			case 1:
//				destination = "ftp://infrastructure.lab.example.com?" + "user=ftpuser1&password=w0rk1n";
//				break;
//			case 2:
//				destination = "ftp://infrastructure.lab.example.com?" + "user=ftpuser2&password=w0rk0ut";
//				break;
//			default:
//				destination = "file:others";
//			}
